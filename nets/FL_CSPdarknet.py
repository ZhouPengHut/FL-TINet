...
#---------------------------------------------------#
#   The structure of FL_CSPdarknet
#---------------------------------------------------#
...
class FL_CSPDarkNet(nn.Module):
    def __init__(self):
        super(FL_CSPDarkNet, self).__init__()
        # use two 3x3 convolutions with a stride of 2x2 to compress the height and width
